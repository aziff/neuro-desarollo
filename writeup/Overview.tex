...
\begin{figure}[!htb]\centering
   \begin{minipage}{0.49\textwidth}
     \frame{\includegraphics[width=\linewidth]{OverviewAux/age_initial}}
   \end{minipage}
   \begin {minipage}{0.49\textwidth}
     \frame{\includegraphics[width=\linewidth]{OverviewAux/age_final}}
   \end{minipage}
\end{figure}
...
\begin{center}
\includegraphics[width=100mm]{OverviewAux/weight_length_babies.jpg}
\end{center}
...
\begin{center}
\includegraphics[scale=.51]{OverviewAux/growth}
\end{center}

\bibliography{OverviewAux/nd_bib}
